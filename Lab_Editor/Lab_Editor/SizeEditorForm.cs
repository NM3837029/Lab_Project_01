...
public class SizeEditorForm : Form
{
    ...
    // 当たり判定の追従結果。ページ側の値をそのまま透過する。
    public int ResultHitboxWidth => _page.ResultHitboxWidth;
    public int ResultHitboxHeight => _page.ResultHitboxHeight;
    ...
    public SizeEditorForm(string imagePath, float initialScale,
                          ...
                          int hitboxW = 0, int hitboxH = 0, bool hasScale = true)
    {
        // ウィンドウのタイトル・サイズを設定する。
        Text = "大きさの設定";
        ...
        _page = new SizeEditorPageControl(imagePath, initialScale, logicalW, logicalH, hitboxW, hitboxH, hasScale) { Dock = DockStyle.Fill };
