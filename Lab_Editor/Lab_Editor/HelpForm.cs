...
public class HelpForm : Form
{
    ...
    public HelpForm()
    {
        ...
        SubHeading("📦 配布用パッケージ");
        Body("メニュー「ファイル」→「配布用パッケージを作る...」から開きます。ゲーム本体と assets / img / sound / se をひとまとめにしたzipを dist フォルダに作る画面で、これを渡せば相手は展開してexeをダブルクリックするだけで遊べます。ステージやアセットだけ直したときは「ビルドし直さず…」にチェックを入れると速く済みます。");
